...
//           <SparklesIcon className="w-8 h-8 text-yellow-400 opacity-50 animate-pulse" />
//         </div>
//         <div className="absolute top-30 left-40 animate-pulse">
//           <Star className="w-8 h-8 text-yellow-400 opacity-50 animate-pulse" />
//         </div>
//         <div className="absolute top-40 right-20 animate-float animation-delay-2000">
//           <ZapIcon className="w-10 h-10 text-blue-400 opacity-50 animate-pulse" />
//           <Star className="w-8 h-8 text-yellow-400 opacity-50 animate-pulse" />
//         </div>
...
//           <Star className="w-8 h-8 text-yellow-400 opacity-50 animate-pulse bottom-0 right-3/4" />
//         </div>
  ...
  return (
    ...
    <div className="relative z-10">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center py-20 lg:py-32 relative">
          <RocketIcon className="w-16 h-16 text-purple-500 mx-auto mb-6 animate-bounce" />
          <motion.h1  className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600 animate-pulse ">
            <motion.span  initial={{y:100,opacity:0}}
                        animate={{y:0,opacity:1}}
                        transition={{duration:2,delay:1.2}}>AI-Powered</motion.span> Social Media <motion.span initial={{y:-100,opacity:0}}
                        animate={{y:0,opacity:1}}
                        transition={{duration:2,delay:1.2}}>Content Generator</motion.span>
          </motion.h1>
          <p className="text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
            Create engaging content for Twitter, Instagram, and LinkedIn with
            cutting-edge AI technology.
